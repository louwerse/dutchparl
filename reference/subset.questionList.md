...
- x:
  ...
  A questionList object, most of the time the questions object from the
  Dutch Parliamentary Behaviour Dataset.

- df:

  The name of the data.frame in the questionList to filter on. Options
  include metaList, questionerList, responderList, and categoryList.
